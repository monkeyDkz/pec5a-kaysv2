...
const Map = forwardRef<MapRef, MapProps>(function Map({ children, styles, projection, ...props }, ref) {
  ...
  }, []) // Mount-only: map instance created once
...
function MapMarker({
  ...
  }, []) // Mount-only: marker created once
  ...
  }, [map]) // Re-run when map instance changes
